...
async function getAboutGithub(){
  try{
    ...
    const resposta = await fetch('https://api.github.com/users/gaab98')
    ...
    about.innerHTML = `
      ...
      <!-- Imagem da Seção About -->
          ...
          <article class="about-content">
            <h2>Sobre mim</h2>
            <p>
              Sou estudante de Análise e Desenvolvimento de Sistemas e um profissional em transição de carreira para a tecnologia, tenho experiência de mais de 5 anos em Recursos Humanos e People Analytics em empresas como Accenture, Itaú e Viva Real (Grupo OLX Brasil), venho desenvolvendo minhas habilidades na área de tecnologia por meio de estudos e projetos práticos.
            </p>
            <p>
              Consolidando essa transição com o bootcamp Java Full Stack na Generation Brasil, desenvolvendo competências práticas em engenharia de software e arquitetura de sistemas com Java, Spring Boot, API REST, JWT, SQL, Git, HTML, CSS, JavaScript e React.
            </p>
            ...
            <div class="about-buttons-data">
              ...
              <div class="buttons-container">
                ...
                <a href="https://drive.google.com/file/d/1JEAG5LyL3JPnoHp2xo4iZywqidEl_zlh/view?usp=sharing" target="_blank" class="botao-outline">Currículo</a>
              </div>
...
async function getProjectsGitHub(){
  try{
    ...
    const resposta = await fetch('https://api.github.com/users/gaab98/repos?sort=update&per_page=6')
